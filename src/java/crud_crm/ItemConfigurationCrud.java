...
gridata = i + ","+itemconfiguration.getConfigurationName() + "," + itemconfiguration.getHasColour()+ "," + itemconfiguration.getIsPurchased()+ "," + itemconfiguration.getIsProduction()+ "," + itemconfiguration.getIsSold() + "," + itemconfiguration.getHasDimensions()+ "," + itemconfiguration.getHasProductionTemplate();
i++;
}
}
return gridata;
