...
//gridata = i + ","+crmposline.getPrice() + "," + crmposline.getQty() + "," + crmposline.getDiscount() + "," + crmposline.getInterest() + "," + crmposline.getPercentDisc() + "," + crmposline.getPercentInt() + "," + crmposline.getAmount() + "," + crmposline.getVatableAmount() + "," + crmposline.getVatAmount() + "," + crmposline.getUomQty() + "," + crmposline.getMemo() + "," + crmposline.getDimensionLength() + "," + crmposline.getDimensionWidth() + "," + crmposline.getDimensionThickness() + "," + crmposline.getDimensionThicknessNum() + "," + crmposline.getDimensionThicknessDenom() + "," + crmposline.getDimensionLengthNum() + "," + crmposline.getDimensionLengthDenom() + "," + crmposline.getDimensionWidthNum() + "," + crmposline.getDimensionWidthDenom() + "," + crmposline.getRalNo() + "," + crmposline.getCrmPos().getPosId() + "," + crmposline.getItemByItemId().getItemId() + "," + crmposline.getItemByItemServiceId().getItemId() + "," + crmposline.getItemSale().getItemSaleId() + "," + crmposline.getAllStatus().getStatusId() + "," + crmposline.getCrmUomByUomId().getUomId() + "," + crmposline.getCrmUomByDimensionUomId().getUomId();

gridata = i + ","+crmposline.getPrice() + "," + crmposline.getQty();
