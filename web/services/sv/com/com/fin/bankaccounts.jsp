...
<%@ page import="model.*,crud.fin.*" %>




<%!
String account_name,bank_id,currency_id,account_number,account_type,isdefault ;
...
BankAccountCrud crudBankAccount = new BankAccountCrud();
if (actiontype.equals("0")) {
if (id.equals("-1")) {
myfeedback = new Gson().toJson(crudBankAccount.cud("c", jsonData));
out.print(myfeedback);
} else {
myfeedback = new Gson().toJson(crudBankAccount.cud("u", jsonData));
out.print(myfeedback);
}
} else if (actiontype.equals("-5")) {
myfeedback = new Gson().toJson(crudBankAccount.cud("d", jsonData));
out.print(myfeedback);
}
} catch (Exception e) {
