...
PaymodeCrud crudPaymode = new PaymodeCrud();
if (actiontype.equals("0")) {
if (id.equals("-1")) {
myfeedback = new Gson().toJson(crudPaymode.cud("c", jsonData));
out.print(myfeedback);
} else {
myfeedback = new Gson().toJson(crudPaymode.cud("u", jsonData));
out.print(myfeedback);
}
} else if (actiontype.equals("-5")) {
myfeedback = new Gson().toJson(crudPaymode.cud("d", jsonData));
out.print(myfeedback);
}
} catch (Exception e) {
