...
{type: "calendar",name:"admndate" , dateFormat: "%Y-%m-%d" , serverDateFormat: "%Y-%m-%d" , required:"true" ,label: "Admndate", value:"<% out.print(admndate); %>"},
{type: "input", name:"customercode",label:"Customercode", value:"<% out.print(customercode); %>", required:"true" , validate:"ValidateLength"},
{type: "input", name:"surname",label:"Surname", value:"<% out.print(surname); %>", required:"true" , validate:"ValidateLength"},
{type: "input", name:"othername",label:"Othername", value:"<% out.print(othername); %>", required:"true" , validate:"ValidateLength"},
{type: "select", name:"title",label: "Title" , options:[<% out.print(CHtitle.LoadCombo("salutation", queryFilter, title)); %>]} ,
{type: "input", name:"idno",label:"Idno", value:"<% out.print(idno); %>", required:"true" , validate:"ValidateLength,ValidInteger"},
{type: "input", name:"vatno",label:"Vatno", value:"<% out.print(vatno); %>" , validate:"ValidateLength"},
{type: "input", name:"pinno",label:"Pinno", value:"<% out.print(pinno); %>", required:"true" , validate:"ValidateLength"},
{type: "input", name:"memo",label:"Memo", value:"<% out.print(memo); %>" , validate:"ValidateLength"},
...
{type: "combo", name:"customercategoryid",label: "Customercategoryid", filtering:true , required:"true", options:[<% out.print(CHcustomer.LoadCombo("customer", queryFilter, customercategoryid)); %>]} ,
{type: "combo", name:"agentid",label: "Agentid", filtering:true , options:[<% out.print(CHagent.LoadCombo("hrmemployee", queryFilter, agentid)); %>]} ,
{type: "newcolumn"},
{type: "checkbox", name:"credit", label: "Credit" <% out.print(SH.formCheckbox(credit)); %> , checked: true , required:"true"},
{type: "input", name:"creditlimit",label:"Creditlimit", value:"<% out.print(creditlimit); %>" , validate:"ValidateLength,ValidNumeric"},
{type: "combo", name:"paytermid",label: "Paytermid", filtering:true , required:"true", options:[<% out.print(CHpayterm.LoadCombo("payterm", queryFilter, paytermid)); %>]} ,
{type: "input", name:"contactperson",label:"Contactperson", value:"<% out.print(contactperson); %>" , validate:"ValidateLength"},
{type: "input", name:"primarymobileno",label:"Primarymobileno", value:"<% out.print(primarymobileno); %>", required:"true" , validate:"ValidateLength"},
{type: "input", name:"primarylandline",label:"Primarylandline", value:"<% out.print(primarylandline); %>" , validate:"ValidateLength"},
{type: "input", name:"primaryemail",label:"Primaryemail", value:"<% out.print(primaryemail); %>", required:"true" , validate:"ValidateLength,ValidEmail"},
{type: "input", name:"boxaddress",label:"Boxaddress", value:"<% out.print(boxaddress); %>", required:"true" , validate:"ValidateLength"},
{type: "input", name:"boxaddresscode",label:"Boxaddresscode", value:"<% out.print(boxaddresscode); %>", required:"true" , validate:"ValidateLength"},
{type: "input", name:"boxaddresstown",label:"Boxaddresstown", value:"<% out.print(boxaddresstown); %>" , validate:"ValidateLength"},
{type: "input", name:"physicaladdress",label:"Physicaladdress", value: "<% out.print(physicaladdress); %>",rows:3 , validate:"ValidateLength"},
,
