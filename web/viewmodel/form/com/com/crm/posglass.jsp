...
{type: "combo", name:"itemsaleid",label: "Price ", filtering:true , required:"true", readonly:"true", options:[<% out.print(CHdimensionuomid.LoadCombo("itemsaleid", "WHERE crmUom.uomId=4", itemsaleid)); %>]} ,
