...
createdt=DH.DatetimetoStrDatetime(conauth.getCreatedt());
writedt=DH.DatetimetoStrDatetime(conauth.getWritedt());
}
}
} else {
...
{type: "input", name:"username",label:"Username", value: "<% out.print(username); %>", required:"true" },
{type: "input", name:"password",label:"Password", value: "<% out.print(password); %>", required:"true" },
{type: "input", name:"loginkey",label:"Login key", value: "<% out.print(loginkey); %>", required:"true" },
{type: "combo", name:"userid",label: "User", filtering:true , required:"true", options:[<% out.print(CHuser.LoadCombo("user", queryFilter, userid)); %>]} ,
{type: "combo", name:"profileid",label: "Profile", filtering:true , required:"true", options:[<% out.print(CHprofile.LoadCombo("profile", queryFilter, profileid)); %>]} ,
{type: "select", name:"statusid",label: "Status" , required:"true", options:[<% out.print(CHstatus.LoadCombo("status", queryFilter, statusid)); %>]} ,
{type: "input", name:"branchid",label:"Branch", value: "<% out.print(branchid); %>" },
