...
<html xmlns="http://www.w3.org/1999/xhtml">
        ...
        <body>
            <script>
                ...
                salesorderGrid.setColTypes("ro,ro,ro,ro,ro,ro,ro,ro,ro,ro");
                salesorderGrid.setHeader("#,Sales Number,Quote Number,Date,Quote Amount,Sale Amount,Balance,Customer Name,Status,Raised By");
                salesorderGrid.setColAlign("left,left,left,left,left,left,left,left,left,left");
                salesorderGrid.setInitWidthsP("3,10,10,10,10,10,10,*,10,10");
                salesorderGrid.attachHeader(",#text_filter,#text_filter,#text_filter,#text_filter,#text_filter,#text_filter,#text_filter,#text_filter,#text_filter");
                salesorderGrid.setColSorting("int,str,str,str,str,str,str,str,str,str");
                salesorderGrid.init();
...
var loadPath='viewmodel/grid/com/com/crm/salesorder.jsp';
                ...
                salesorderGrid.attachEvent("onRowSelect", function (rId, cInd) {
                    ...
                    salesorderGridOnselect(salesorderGrid, salesOrderkey, rId);
                });
