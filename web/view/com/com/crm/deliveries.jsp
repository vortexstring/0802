    ...
    <body>
        <script>
            ...
            deliveriesGrid.attachEvent("onRowSelect", function (rId, cInd) {
                ...
                deliveriesGridOnselect(deliveriesGrid, deliveriesId, rId);
            });

 function deliveriesGridOnselect(mygrid, rId, loadPath) {
                var pname = mygrid.cells(rId, 1).getValue();
                deliveriescreateWindow(rId, pname, mygrid, loadPath);
            }
            /**************************END OF OBJECTS EVENTS********************************/
            function deliveriescreateWindow(rId, pname, mygrid) {
                var win = dhxWins.createWindow("deliveries" + rId, 140, 100, 1200, 550);
...
//                });
                deliverieslineGrid.load("out/grid/mfc/com/customersorder.php", "json");
                ...
                customersDeliveriesForm = createDeliveriesform(deliverieslineLayout, deliverieslineGrid, -1);

            }
            function createDeliveriesform(deliverieslineLayout, deliverieslineGrid, rId) {
                ...
                customersDeliveriesForm.loadStruct("./viewmodel/form/com/com/crm/customersorders.jsp?id=" + rId, function () {
