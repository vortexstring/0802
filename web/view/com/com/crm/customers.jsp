    ...
    <body>
        <script>
            ...
            function createCustomersform(customerLayout, customersGrid, rId) {
                ...
                customersForm.attachEvent("onKeyDown",function(inp, ev, name, value){
                    window.activeformitem=name;
                });
               ...
               var caption = customersForm.getItemLabel(name);

                    customValidationMessage(caption, value,name);
