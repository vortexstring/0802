...
<html xmlns="http://www.w3.org/1999/xhtml">
        ...
        <body>
            <script>
                ...
                salesinvoiceGrid.setColTypes("ro,ro,ro,ro,ro,ro,ro,ro,ro,ro");
                salesinvoiceGrid.setHeader("#,Sales Number,Quote Number,Date,Quote Amount,Sale Amount,Balance,Customer Name,Status,Raised By");
                salesinvoiceGrid.setColAlign("left,left,left,left,left,left,left,left,left,left");
                salesinvoiceGrid.setInitWidthsP("3,10,10,10,10,10,10,*,10,10");
                salesinvoiceGrid.attachHeader(",#text_filter,#text_filter,#text_filter,#text_filter,#text_filter,#text_filter,#text_filter,#text_filter,#text_filter");
                salesinvoiceGrid.setColSorting("int,str,str,str,str,str,str,str,str,str");
...
var loadPath='viewmodel/grid/com/com/crm/salesinvoice.jsp';
                ...
                salesinvoiceGrid.attachEvent("onRowSelect", function (rId, cInd) {
                    ...
                    salesinvoiceGridOnselect(salesinvoiceGrid, salesOrderkey, rId);
                });


                /**************************END OF OBJECTS EVENTS********************************/
                function salesinvoicecreateWindow(rId, pname, mygrid) {
                    var win = dhxWins.createWindow("salesinvoice" + rId, 50, 5, 1200, 600);
