...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <script>
            ...
            usersGrid.setColAlign("left,left,left,left,center");
            ...
            usersGrid.setColTypes("ro,ro,ro,ch");
            usersGrid.setColSorting(",str,str,int");
            ...
            /* D *************************OBJECTS EVENTS***********************************/
            usersToolbar.attachEvent("onXLE", function () { window.lastvisit = 'new';});
            usersToolbar.attachEvent("onClick", function (itemId) {  usersToolbarOnclick(itemId, usersLayout, usersGrid);    });
            usersGrid.attachEvent("onXLS", function () { usersLayout.cells("a").progressOn();  });
            usersGrid.load('viewmodel/grid/com/com/sec/users.jsp', 'json');
            usersGrid.attachEvent("onXLE", function () {  usersLayout.cells("a").progressOff();  });
            usersForm.attachEvent("onButtonClick", function(id){  usersFormOnclick(id,usersForm,usersGrid);  });
            rId = -1;
            //  usersLayout.cells("b").attachURL("in/forms/com/com/users.php", null, {key: rId});

            usersGrid.attachEvent("onRowSelect", function (rId, cInd) {  usersGridOnselect(rId, usersLayout); });
