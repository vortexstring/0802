...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        <script>
            ...
            var loadPath = 'viewmodel/grid/com/com/inv/stores.jsp';
            ...
            receiptsGrid.attachEvent("onRowSelect", function (rId, cInd) {
                ...
                receiptsGridOnselect(receiptsGrid, receiptsId, rId);
            });

            function receiptsGridOnselect(mygrid, rId, loadPath) {
                var pname = mygrid.cells(rId, 2).getValue();
                receiptscreateWindow(rId, pname, mygrid, loadPath);
            }
            /**************************END OF OBJECTS EVENTS********************************/

            function receiptscreateWindow(rId, pname, mygrid, loadPath) {
                var win = dhxWins.createWindow("receipts" + rId, 350, 50, 800, 600);
                ...
                var receiptslineLayout = win.attachLayout({
                    pattern: "2E",
                    cells: [
                        {id: "a", text: "FORM", header: false, height: 220},
...
//                });
                receiptslineGrid.load("out/grid/mfc/com/customersreceipts.php", "json");
