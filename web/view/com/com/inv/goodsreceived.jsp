...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        <script>
            ...
            salesinvoiceGrid.setHeader("#,GR Number,Received Date,Delivery Number,Invoice Number,Supplier Name,Status");
            salesinvoiceGrid.setColAlign("left,left,left,left,left,left,left,left");
            salesinvoiceGrid.setInitWidthsP("3,10,15,20,15,*,15");
