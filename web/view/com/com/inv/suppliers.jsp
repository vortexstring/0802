...
//var supplierFormLayout =supplierscreateWindow(rId, pname, suppliersGrid,loadPath);
...
//            });
            ...
            function  supplierscreateWindow(rId, pname, suppliersGrid) {
                ...
                var win = dhxWins.createWindow("Suppliers " + rId, 450, 130, 800, 500);
           ...
           function createSuppliersform(supplierFormLayout, suppliersGrid, rId) {
               ...
               supplierFormLayout.cells("a").progressOn();
                ...
                alert("./viewmodel/form/com/com/prc/suppliers.jsp?id=" + rId);
