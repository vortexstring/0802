...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        <script>
            ...
            customersGrid.setColTypes("ro,ro,ro,ro,ro,ro,ro,ro");
            customersGrid.setHeader("#,Item,Adjustment Date,Store,Quantity,Type,Reason,Status");
            customersGrid.setColAlign("left,left,left,left,left,left,left,left");
            customersGrid.setInitWidthsP("3,12,15,10,15,15,15,15");
            customersGrid.setColumnColor(",,#d5f1ff,,,,,,,");
            customersGrid.attachHeader(",#text_filter,#text_filter,#combo_filter,#text_filter,#text_filter,#text_filter,#combo_filter");
...
//alert(rId);
            ...
            function  customerscreateWindow(rId, pname, customersGrid, loadPath) {
                ...
                var win = dhxWins.createWindow("Customers " + rId, 330, 75, 800, 570);
